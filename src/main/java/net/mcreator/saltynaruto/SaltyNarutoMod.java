package net.mcreator.saltynaruto;
...
@Mod("salty_naruto")
public class SaltyNarutoMod {
	public static final Logger LOGGER = LogManager.getLogger(SaltyNarutoMod.class);
	public static final String MODID = "salty_naruto";

	public SaltyNarutoMod() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		SaltyNarutoModItems.REGISTRY.register(bus);
